class Player53(object):
    ...
    def heuristic(self, board, block_number, player):
        ...
        # for i in range(3):
        # 	for j in range(3):
        # 		print(board[x_start+i][y_start+j],end=" ")
        # 	print("\n")
        ...
        for i in range(3):
            ...
            if count_of_empty_cells == 0:
                ...
                if (
                    (board[x][y] == board[x][y + 1] and board[x][y] == player)
                    or (
                        board[x][y + 1] == board[x][y + 2] and board[x][y + 1] == player
                    )
                    or (board[x][y] == board[x][y + 2] and board[x][y] == player)
                ):
                    heuristic_value += 10
                elif (
                    (board[x][y] == board[x][y + 1] and board[x][y] != player)
                ...
                if (
                    board[x][y] == player
                    or board[x][y + 1] == player
                    or board[x][y + 2] == player
                ):
                    heuristic_value += 1
                else:
                    heuristic_value -= 1
        ...
        for i in range(3):
            ...
            if count_of_empty_cells == 0:
                ...
                if (
                    (board[x][y] == board[x + 1][y] and board[x][y] == player)
                    or (
                        board[x + 1][y] == board[x + 2][y] and board[x + 1][y] == player
                    )
                    or (board[x][y] == board[x + 2][y] and board[x][y] == player)
                ):
                    heuristic_value += 10
                elif (
                    (board[x][y] == board[x + 1][y] and board[x][y] != player)
                ...
                if (
                    board[x][y] == player
                    or board[x + 1][y] == player
                    or board[x + 2][y] == player
                ):
                    heuristic_value += 1
                else:
                    heuristic_value -= 1
        ...
        if count_of_empty_cells == 0:
            if board[x_start][y_start] == player and (
                ...
                and board[x + 2][y + 2] == board[x + 1][y + 1]
            ):
                return 100
            ...
            if (
                (board[x][y] == board[x + 1][y + 1] and board[x][y] == player)
                or (
                    board[x + 1][y + 1] == board[x + 2][y + 2]
                    and board[x + 1][y + 1] == player
                )
                or (board[x][y] == board[x + 2][y + 2] and board[x][y] == player)
            ):
                heuristic_value += 10
            elif (
                (board[x][y] == board[x + 1][y + 1] and board[x][y] != player)
            ...
            if (
                ...
                or board[x_start + 1][y_start + 1] == player
                or board[x_start + 2][y_start + 2] == player
            ):
                heuristic_value += 1
            else:
                heuristic_value -= 1
        ...
        if count_of_empty_cells == 0:
            ...
            if (
                board[x][y] == player
                or board[x - 1][y + 1] == player
                or board[x - 2][y + 2] == player
            ):
                heuristic_value += 1
            else:
                heuristic_value -= 1
