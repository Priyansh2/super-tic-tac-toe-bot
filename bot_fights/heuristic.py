...
def check(b, p_block, flag):
    ...
    for i in range(0, 3):
        ...
        if flag_r == 1 or flag_rr == 1:
            ...
            utility[index] = (
                int(pow(10, abs(int(sumr)) - 1)) + (sumr - int(sumr)) * factor_r
            )
            if sumr < 0:
        ...
        if flag_c == 1 or flag_cc == 1:
            ...
            utility[index + 3] = (
                int(pow(10, abs(int(sumc)) - 1)) + (sumc - int(sumc)) * factor_c
            )
            if sumc < 0:
        ...
        if flag_d1 == 1 or flag_dd1 == 1:
            ...
            utility[6] = (
                int(pow(10, abs(int(sumd1)) - 1)) + (sumd1 - int(sumd1)) * factor_d1
            )
            if sumd1 < 0:
                utility[6] = -utility[6]
        if flag_d2 == 1 or flag_dd2 == 1:
            ...
            utility[7] = (
                int(pow(10, abs(int(sumd2)) - 1)) + (sumd2 - int(sumd2)) * factor_d2
            )
            if sumd2 < 0:
                utility[7] = -utility[7]
        index += 1
