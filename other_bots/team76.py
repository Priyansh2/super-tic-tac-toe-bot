...
class Player76:
    ...
    def block_win(self, player, game, base1, base2):
        ...
        base2 *= 3
        if (
            game[base1 + 0][base2 + 0] == player
            and game[base1 + 1][base2 + 1] == player
            and game[base1 + 2][base2 + 2] == player
        ):
            return 1
        if (
            game[base1 + 0][base2 + 2] == player
            and game[base1 + 1][base2 + 1] == player
            and game[base1 + 2][base2 + 0] == player
        ):
            return 1
        for i in range(0, 3):
            if (
                game[base1 + i][base2 + 0] == player
                and game[base1 + i][base2 + 1] == player
                and game[base1 + i][base2 + 2] == player
            ):
                return 1
            if (
                game[base1 + 0][base2 + i] == player
                and game[base1 + 1][base2 + i] == player
                and game[base1 + 2][base2 + i] == player
            ):
                return 1
        return 0
    ...
    def completed_board(self, game):
        for i in range(0, 9):
            for j in range(0, 9):
                if (
                    game[i][j] == '-'
                    and self.block_win('x', game, i // 3, j // 3) == 0
                    and self.block_win('o', game, i // 3, j // 3) == 0
                ):
                    return 0
        return 1
    ...
    def assumedScore(self, game, depth, player, flag):
        ...
        for i in range(0, 3):
            for j in range(0, 3):
                ...
                for ii in range(0, 3):
                    if (
                        (game[br + ii][bc + 0] == flag or game[br + ii][bc + 0] == '-')
                        and (
                            game[br + ii][bc + 1] == flag
                            or game[br + ii][bc + 1] == '-'
                        )
                        and (
                            game[br + ii][bc + 2] == flag
                            or game[br + ii][bc + 2] == '-'
                        )
                    ):
                        ...
                        if game[br + ii][bc + 2] == flag:
                            captured += in1
                        if (
                            game[br + ii][bc + 0] == flag
                            and game[br + ii][bc + 1] == flag
                        ):
                            captured += in2
                        if (
                            game[br + ii][bc + 0] == flag
                            and game[br + ii][bc + 2] == flag
                        ):
                            captured += in2
                        if (
                            game[br + ii][bc + 1] == flag
                        ...
                        (
                            game[br + ii][bc + 0] == flagop
                            or game[br + ii][bc + 0] == '-'
                        )
                        and (
                            game[br + ii][bc + 1] == flagop
                            or game[br + ii][bc + 1] == '-'
                        )
                        and (
                            game[br + ii][bc + 2] == flagop
                            or game[br + ii][bc + 2] == '-'
                        )
                    ):
                        ...
                        if (
                            game[br + ii][bc + 0] == flagop
                            and game[br + ii][bc + 1] == flagop
                        ):
                            captured -= in2op
                        if (
                            game[br + ii][bc + 0] == flagop
                            and game[br + ii][bc + 2] == flagop
                        ):
                            captured -= in2op
                        if (
                            game[br + ii][bc + 1] == flagop
                    ...
                    if (
                        (game[br + 0][bc + ii] == flag or game[br + 0][bc + ii] == '-')
                        and (
                            game[br + 1][bc + ii] == flag
                            or game[br + 1][bc + ii] == '-'
                        )
                        and (
                            game[br + 2][bc + ii] == flag
                            or game[br + 2][bc + ii] == '-'
                        )
                    ):
                        ...
                        if game[br + 2][bc + ii] == flag:
                            captured += in1
                        if (
                            game[br + 0][bc + ii] == flag
                            and game[br + 1][bc + ii] == flag
                        ):
                            captured += in2
                        if (
                            game[br + 0][bc + ii] == flag
                            and game[br + 2][bc + ii] == flag
                        ):
                            captured += in2
                        if (
                            game[br + 1][bc + ii] == flag
                    ...
                    if (
                        (
                            game[br + 0][bc + ii] == flagop
                            or game[br + 0][bc + ii] == '-'
                        )
                        and (
                            game[br + 1][bc + ii] == flagop
                            or game[br + 1][bc + ii] == '-'
                        )
                        and (
                            game[br + 2][bc + ii] == flagop
                            or game[br + 2][bc + ii] == '-'
                        )
                    ):
                        ...
                        if (
                            game[br + 0][bc + ii] == flagop
                            and game[br + 1][bc + ii] == flagop
                        ):
                            captured -= in2op
                        if (
                            game[br + 0][bc + ii] == flagop
                            and game[br + 2][bc + ii] == flagop
                        ):
                            captured -= in2op
                        if (
                            game[br + 1][bc + ii] == flagop
                ...
                # DIAGONAL 1
                if (
                    (game[br + 0][bc + 0] == flag or game[br + 0][bc + 0] == '-')
                    and (game[br + 1][bc + 1] == flag or game[br + 1][bc + 1] == '-')
                    and (game[br + 2][bc + 2] == flag or game[br + 2][bc + 2] == '-')
                ):
                    ...
                    if (
                        game[br + 0][bc + 0] == flag
                        and game[br + 1][bc + 1] == flag
                        and game[br + 2][bc + 2] == flag
                    ):
                        captured += in3

                if (
                    (game[br + 0][bc + 0] == flagop or game[br + 0][bc + 0] == '-')
                    and (game[br + 1][bc + 1] == flagop or game[br + 1][bc + 1] == '-')
                    and (game[br + 2][bc + 2] == flagop or game[br + 2][bc + 2] == '-')
                ):
                    ...
                    if game[br + 2][bc + 2] == flagop:
                        captured -= in1op
                    if (
                        game[br + 0][bc + 0] == flagop
                        and game[br + 1][bc + 1] == flagop
                    ):
                        captured -= in2op
                    if (
                        game[br + 1][bc + 1] == flagop
                        and game[br + 2][bc + 2] == flagop
                    ):
                        captured -= in2op
                    if (
                        game[br + 0][bc + 0] == flagop
                ...
                # DIAGONAL 2
                if (
                    (game[br + 2][bc + 0] == flag or game[br + 2][bc + 0] == '-')
                    and (game[br + 1][bc + 1] == flag or game[br + 1][bc + 1] == '-')
                    and (game[br + 0][bc + 2] == flag or game[br + 0][bc + 2] == '-')
                ):
                    ...
                    if (
                        game[br + 2][bc + 0] == flag
                        and game[br + 1][bc + 1] == flag
                        and game[br + 0][bc + 2] == flag
                    ):
                        captured += in3

                if (
                    (game[br + 2][bc + 0] == flagop or game[br + 2][bc + 0] == '-')
                    and (game[br + 1][bc + 1] == flagop or game[br + 1][bc + 1] == '-')
                    and (game[br + 0][bc + 2] == flagop or game[br + 0][bc + 2] == '-')
                ):
                    ...
                    if game[br + 0][bc + 2] == flagop:
                        captured -= in1op
                    if (
                        game[br + 2][bc + 0] == flagop
                        and game[br + 1][bc + 1] == flagop
                    ):
                        captured -= in2op
                    if (
                        game[br + 1][bc + 1] == flagop
                        and game[br + 0][bc + 2] == flagop
                    ):
                        captured -= in2op
                    if (
                        game[br + 2][bc + 0] == flagop
                ...
                block[i][j] = (
                    captured * ((1.0 / depth) ** (1.0 / 3.0))
                ) * 1.0 / max_val + 1.0

        '''for iii in range(0,3):
			for jjj in range(0,3):
				print(block[iii][jjj],end=" ")
			print('')
		'''
        ...
        for i in range(0, 3):
            if (
                (finished[i][0] == 1 or finished[i][0] == 0)
                and (finished[i][1] == 1 or finished[i][1] == 0)
                and (finished[i][2] == 1 or finished[i][2] == 0)
            ):
                final_score += out3 * (block[i][0] * block[i][1] * block[i][2])

            elif (
                (finished[i][0] == 2 or finished[i][0] == 0)
                and (finished[i][1] == 2 or finished[i][1] == 0)
                and (finished[i][2] == 2 or finished[i][2] == 0)
            ):
                final_score += out3 * (block[i][0] * block[i][1] * block[i][2])
            else:
            ...
            if (
                (finished[0][i] == 1 or finished[0][i] == 0)
                and (finished[1][i] == 1 or finished[1][i] == 0)
                and (finished[2][i] == 1 or finished[2][i] == 0)
            ):
                final_score += out3 * (block[0][i] * block[1][i] * block[2][i])

            elif (
                (finished[0][i] == 2 or finished[0][i] == 0)
                and (finished[1][i] == 2 or finished[1][i] == 0)
                and (finished[2][i] == 2 or finished[2][i] == 0)
            ):
                final_score += out3 * (block[0][i] * block[1][i] * block[2][i])
            else:
                final_score += out3 * (1.0)
        ...
        if (
            (finished[0][0] == 1 or finished[0][0] == 0)
            and (finished[1][1] == 1 or finished[1][1] == 0)
            and (finished[2][2] == 1 or finished[2][2] == 0)
        ):
            final_score += out3 * (block[0][0] * block[1][1] * block[2][2])

        elif (
            (finished[0][0] == 2 or finished[0][0] == 0)
            and (finished[1][1] == 2 or finished[1][1] == 0)
            and (finished[2][2] == 2 or finished[2][2] == 0)
        ):
            final_score += out3 * (block[0][0] * block[1][1] * block[2][2])
        else:
            final_score += out3 * (1.0)
        ...
        if (
            (finished[2][0] == 1 or finished[2][0] == 0)
            and (finished[1][1] == 1 or finished[1][1] == 0)
            and (finished[0][2] == 1 or finished[0][2] == 0)
        ):
            final_score += out3 * (block[2][0] * block[1][1] * block[0][2])

        elif (
            (finished[2][0] == 2 or finished[2][0] == 0)
            and (finished[1][1] == 2 or finished[1][1] == 0)
            and (finished[0][2] == 2 or finished[0][2] == 0)
        ):
            final_score += out3 * (block[2][0] * block[1][1] * block[0][2])
        else:
            final_score += out3 * (1.0)
    ...
    def minimax(
        ...
        if time.time() - self.t0 >= 9 and firstcall != 0:
            self.complete = False
        ...
        if (
            self.board_win('o', game)
            or self.board_win('x', game)
            or self.completed_board(game)
            or depth >= maxdepth
        ):
            return self.assumedScore(game, depth, player, flag)
    ...
    def move(self, temp_board, temp_block, old_move, flag):
        ...
        if previous_move_c == -1 and previous_move_r == -1:
            ...
            selected_block = (previous_move_c) % 3 + (
                (previous_move_r) % 3
            ) * 3  # x is the column y is the row
        self.complete = True
        answer = self.minimax(
            flag, temp_board, 0, 1, -self.INF, self.INF, selected_block, flag, 5
        )
        t1 = time.time()
        return answer
        max_depth = 5
